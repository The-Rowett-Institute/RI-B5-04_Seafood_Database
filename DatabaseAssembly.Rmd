...
df_UK_seafoodDB_capita_simp <- df_UK_seafoodDB_capita[]
...
# Change struucture of the dataframes
...
# unstack seafood database to calculate supplies
...
# Merge data frame with populaiton data
...
df_seafoodDB_pop_short$Supplies_pcw <- (df_seafoodDB_pop_short$Supplies/
                                            df_seafoodDB_pop_short$UKPOP)/52
df_seafoodDB_pop_short$Consumpiton_pcw <- (df_seafoodDB_pop_short$Consumption/
                                            df_seafoodDB_pop_short$UKPOP)/52

# Merge nutrient data with seafood database
df_seafoodDB_comp_pcw_short <- merge(df_seafoodDB_pop_short, df_nutrient_short, "Species")
str(df_seafoodDB_comp_pcw_short)
