---
title: "Loading_HMRC-data-trial_DELETE-LATER"
...
This R Markdown document outlines how the HRMC trade data was complied and cleaned. The HRMC trade data ranges from 2009 - 2019. 
...
df_HRMC.sum <- df_HMRC_4DB %>% group_by(Species = EUMOFA_MCS_AL_NEW, SpeciesType = SpeciesType_AL, Year, Commodity) %>% summarise(`Net Mass (g)`= sum(`Net Mass (kg)`)*1000,`Net Mass (kg)`= sum(`Net Mass (kg)`))
