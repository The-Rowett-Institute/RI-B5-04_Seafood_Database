...
This R Markdown document outlines how the data set to map UK seafood supply chains was created. 
...
$$seafood availability = ((production - non food uses) + imports) - exports$$
...
plot(FAO_seafood_availability$Available~ FAO_seafood_availability$Group.1, pch=19, xlab="Year", ylab="Seafood availability (thousand tonnes)")
```
