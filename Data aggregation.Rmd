...
MCS_translations <- vroom(file=paste(filepath,"AllMainCommercialSpecies_translationsV2.csv", sep="/"))
...
# Select desired columns for cleaned data set
df_cleaned_UK_HMRC_200919 <- df_trade_HMRC_data[c("DataSupplier.y", "DataSet", "Commodity", "SeafoodSpecies", "SpeciesType.x", "SACN.y", "Value", "Units", "Year", "TemporalResolution", "Flag", "FlagDescription")]
