...
# Select desired columns for cleaned data set
df_cleaned_UK_HMRC_200919 <- df_trade_HMRC_data[c("DataSupplier.y", "DataSet", "Commodity", "SeafoodSpecies", "SACN", "Volume", "Units", "Year", "TemporalResolution", "Flag", "FlagDescription")]
...
# Read in .csv file 
df_PHE_seafoodComp <- vroom(file=paste(filepath,"PHE_seafoodNutrientContent.csv", sep="/"), na = c("N/A", "Tr")) 
# Both N/A and Tr different 

# Check for missing Volumes
md.pattern(df_PHE_seafoodComp, rotate.names = TRUE)

# Identify column names
colnames(df_PHE_seafoodComp)

# Specify the supplier
df_PHE_seafoodComp$DataSupplier <- "PHE"
...
# Read in .csv file 
df_Norwegian_seafoodComp <- vroom(file=paste(filepath,"Norwegian_seafoodNutrientContent.csv", sep="/"), na = c("M", ""))

# Check for missing Volumes
md.pattern(df_Norwegian_seafoodComp, rotate.names = TRUE)

# Identify column names
colnames(df_Norwegian_seafoodComp)

# Specify the dataset
df_Norwegian_seafoodComp$DataSupplier <- "Norwegian"
...
df_PHE_seafoodCompSimp <- df_PHE_seafoodComp[c("SampleDescription", "Protein-g100g", "TotalPUFA-g100g", "VitaminA-µg100g", "VitaminD-µg100g", "VitaminB12-µg100g", "Zinc-mg100g", "Iron-mg100g", "Calcium-mg100g", "Selenium-µg100g", "Iodine-µg100g", "DataSupplier" )]

# Select desired variables
df_Norwegian_seafoodCompSimp <- df_Norwegian_seafoodComp[c("FoodItem", "Protein_g", "Omega3_g", "VitaminA_RAE", "VitaminD_µg", "VitaminB12_µg", "Zinc_mg", "Iron_mg", "Calcium_mg", "Selenium_µg", "Iodine_µg", "DataSupplier")]
...
# Rename variables
names(df_PHE_seafoodCompSimp) <- c("FoodItem", "Protein_g", "TotalPUFA_g", "VitaminA_µg", "VitaminD_µg", "VitaminB12_µg", "Zinc_mg", "Iron_mg", "Calcium_mg", "Selenium_µg", "Iodine_µg", "DataSupplier")

names(df_Norwegian_seafoodCompSimp) <- c("FoodItem", "Protein_g", "TotalPUFA_g", "VitaminA_µg", "VitaminD_µg", "VitaminB12_µg", "Zinc_mg", "Iron_mg", "Calcium_mg", "Selenium_µg", "Iodine_µg", "DataSupplier")
...
```{r Transform dataset}
#Change structure of the data set 
df_seafoodCompSimp_long <- melt(df_seafoodCompSimp, id.vars = c("FoodItem", "DataSupplier"), variable.name ="Nutrient", value.name = "Volume")
...
```{r Add additional variables to data set}
# Add additional variables
df_PHE_seafoodComp$DataSet <- "NutrientAnalysis"
df_PHE_seafoodComp$Commodity <- "NutrientComposition"
df_PHE_seafoodComp$Flag <- "NA"
df_PHE_seafoodComp$FlagDescription <- "NA"
df_seafoodCompSimp$TemporalResolution <- "NA"
df_seafoodCompSimp$Units <- "g/100g"
df_seafoodCompSimp$Year <- "NA"
...
# Change file path to "ProcessedData"
filepath <- paste(data_dir,"ProcessedData", sep="")
write.csv(df_seafoodCompSimp, file =
            paste(filepath,"NutrientComposition_PHENor_PreliminaryCleaned.csv", sep=""), row.names = FALSE)
