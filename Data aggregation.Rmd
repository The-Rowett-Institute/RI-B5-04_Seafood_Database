...
df_NDNS_foodlevel_yr5_6_data <-
  vroom(file = paste(filepath,"NDNS_UK_FoodLevel-Y5-6-edit.csv", sep = "/"))

# Load NDNS yrs 7 - 8 
df_NDNS_foodlevel_yr7_8_data <-
  vroom(file = paste(filepath,"NDNS_UK_FoodLevel-Y7-8-edited.csv", sep = "/"))

# Load NDNS yrs 9
df_NDNS_foodlevel_yr9data <- 
  vroom(file = paste(filepath,"NDNS_UK_FoodLevel_Y9-edit.csv", sep = "/"))

# Load NDNS yrs 10
df_NDNS_foodlevel_yr10_data <- 
  vroom(file = paste(filepath,"NDNS_FoodLevelData_Yr10.csv", sep = "/"))

# Load NDNS yrs 11
df_NDNS_foodlevel_yr11_data <- 
  vroom(file = paste(filepath,"NDNS_FoodLevel-Y11.csv", sep = "/"))
...
df_NDNS_seafood_aggregate_Yr1_11 <- aggregate(totfishperprod ~ Species + SurveyYear + ser, data =
                                                df_NDNS_seafood_consumption_Yr1_11, sum)

```


```{r Calculate the averge amount of each spc}
# Calculate daily fish consumption
df_NDNS_seafood_consumption_Yr1_11$gDay <- df_NDNS_seafood_consumption_Yr1_11$totfishperprod/ 4

# Calculate weekly consumption
df_NDNS_seafood_consumption_Yr1_11$gWeek <- df_NDNS_seafood_consumption_Yr1_11$gDay* 7
