...
df_NDNS_seafood_aggregate_person_Yr1_11 <- aggregate(totfishperprod ~ SeafoodSpecies + SurveyYear + SpeciesType + SACN + DiaryDaysCompleted, data = df_NDNS_seafood_consumption_Yr1_11, sum)
