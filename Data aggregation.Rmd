...
MCS_translations <- vroom(file=paste(filepath,"AllMainCommercialSpecies_translations-edited.csv", sep="/"))
...
df_UK_AllUKLandings_200918$DataSet <- "UK_SeaFisheriesStatistics"
df_UK_AllUKLandings_200918$Commodity <- "CaptureProduction"
df_UK_AllUKLandings_200918$Flag <- "ConV1, ConV2"
df_UK_AllUKLandings_200918$TemporalResolution <- "Annual"
...
write.csv(df_UK_AllUKLandings_200918_clean, file = paste(filepath,"AllLandingsintoUK_MMO_clean.csv", sep = ""))
...
df_UKFarmed_200918$TemporalResolution <- "Annual"
```
...
df_NDNS_foodlevel_yr9_11_data <- 
  vroom(file = paste(filepath,"NDNS_UK_FoodLevel_Y9-11-edit.csv", sep = "/"))
...
df_DEFRA_eatenOut_200915_long$Commodity <- "Purchases"
...
df_DEFRA_eatenOut_200915_cleaned$Year_no <- as.numeric(df_DEFRA_eatenOut_200915_cleaned$Year)
...
df_PHE_composition_data$Flag <- "Con41"
...
# Select desired columns for cleaned data set
df_nutcomp_PHE_cleaned <- df_PHE_composition_data[c("RevisedMCS", "EUMOFA_ST", "FAO_ST", "ISSCAAP_ST", "Golden_2021_ST","Bianchi_2022_ST", "WWF_2022_ST", "SACN", "DataSupplier", "DataSet", "Commodity", "Flag", "Calcium-mg100g", "Iron-mg100g", "Selenium-µg100g", "Zinc-mg100g", "TotalPUFA-g100g" )]
