...
df_NDNS_seafood_aggregate_person_Yr1_11 <- aggregate(totfishperprod ~ SeafoodSpecies + SurveyYear + SpeciesType + SACN, data = df_NDNS_seafood_consumption_Yr1_11, sum)
...
unique(NDNS_UK_Yr1_11_data$SurveyYear) # NA, 37 and 54 entries explored- no serial number so removed from data set
...
respondersPerYear <- NDNS_UK_Yr1_11_data_check %>% 
  group_by(SurveyYear) %>%
