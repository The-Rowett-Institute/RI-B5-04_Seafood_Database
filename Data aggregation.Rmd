...
df_DEFRA_household_200915_data <- vroom(file=paste(filepath,"DEFRA_UK_household-200915-edit.csv", sep="/"))
...
# Select desired columns for cleaned data set
df_DEFRA_household_200918_cleaned <- df_DEFRA_household_200918_aggYear[c("DataSupplier", "DataSet", "Commodity", "Species.x", "SpeciesType", "SACN", "Value", "Units", "Year", "TemporalResolution", "Flag", "FlagDescription")]
