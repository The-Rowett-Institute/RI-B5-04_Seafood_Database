...
df_UK_landings_11_20_data <- vroom(file=paste(filepath,"NS_UK-landings-11-20-edit.csv", sep="/"), na = c(".."))
...
# Read in landing data
df_UK_landings_08_12_data <- vroom(file=paste(filepath,"NS_UK-landings-08-12-edit.csv", sep="/"),na = c(".."))
...
df_MSS_salmon_data <- vroom(file=paste(filepath,"MSS_aquaculture-salmon.csv", sep="/"), na = c(".."))

df_MSS_rainbowTrout_data <- vroom(file=paste(filepath,"MSS_aquaculture-rainbow-trout.csv", sep="/"), na = c(".."))

df_MSS_shellfish_data <- vroom(file=paste(filepath,"MSS_aquaculture-shellfish.csv", sep="/"), na = c(".."))
