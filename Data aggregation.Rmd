...
df_NDNS_seafoodintakeUK_200918$Value <- df_NDNS_seafoodintakeUK_200918$avgIntakeNDNS * df_NDNS_seafoodReported_200918$UKPOP
...
# Save cleaned data as .csv
filepath <- paste(data_dir,"ProcessedData", sep = "")
write.csv(df_NDNS_seafoodintakeUK_200918_cleaned, file = paste(filepath,"ConsumptionData_NDNS_PreliminaryCleaned.csv", sep = ""), row.names = FALSE)
