...
df_UK_landings_11_20_data <- vroom(file=paste(filepath,"NS_UK_landings-11-20-edit.csv", sep="/"), na = c(".."))
...
# Read in landing data
df_UK_landings_08_12_data <- vroom(file=paste(filepath,"NS_UK_landings-08-12-edit.csv", sep="/"),na = c(".."))
...
all_genders <- df_NDNS_UK_data[df_NDNS_UK_data$`Age category` %in% c("Children 1.5-3 years", "Children 4-10 years", "Children 11-18 years", "Adults 19-64 years", "Adults 65 years and over"), ]
