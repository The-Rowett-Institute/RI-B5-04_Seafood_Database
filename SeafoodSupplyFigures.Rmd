...
names(df_UK_intake_tot) <- c("Year", "Value")

# Add additional variable
df_UK_supplies_tot$Commodity <- "Supplied"
df_UK_intake_tot$Commodity <- "Consumed"

# rbind data frames
df_UK_supplies_intake_tot<- rbind(df_UK_supplies_tot, df_UK_intake_tot)

# Plot total seafood supplied and consumed (g/capita/week) between 2009 and 2018. 
ggplot(df_UK_supplies_intake_avg, aes(Year, Value, fill= Commodity)) +
  geom_bar(position = "dodge", stat= "identity", color = "black") +
  scale_y_continuous(name = "Total national seafood supplied (g/capita/week)", limits = c(0,300)) +
  geom_hline(yintercept = 280, linetype = "dashed", color = "red", linewidth = 1.5) + 
  scale_fill_manual(values = c("#E69F00", "#009E73")) +
  theme(legend.title = element_blank()) 
  #scale_colour_identity(name= "", breaks = c("red","#E69F00", "#009E73"),
                        #labels = c("Dietary recommendation", "Consumed", "Supplies"), 
                        #guide= "lengend")
  

# Plot average seafood supply (g/capita/week) between 2009 and 2018 
#ggplot(df_UK_supplies_intake_avg, aes(Year, Consumption_capWeek, fill = SACN)) +
#  geom_bar(position = "stack", stat= "identity", color = "black", 
#           fill = c("#E69F00", "#999999", "#56B4E9", "#999999")) +
#  scale_y_continuous(name = "Seafood supplies (g/capita/week)", limits = c(0,300)) +
#  geom_hline(yintercept = 280, linetype = "dashed", color = "red", linewidth = 1.5) +
#  geom_point(aes(y= Supplies_capWeek, x= Year), color = "#0072B2", size= 4)
...
df_UK_supplies_SACN_avg$Commodity <- "Intake"
...
df_UK_SOI_capita_2018 <- subset(df_UK_seafoodDB_capita_2018, Species == "Cod" | Species == "Haddock" | 
                                  ...
                                  Species == "Whiting"| Species == "Shrimp"| Species == "Seabass" | 
                                  Species == "Mussel" | Species == "Tilapia")

# Make data set long and thin
df_UK_SOI_capita_2018

# Plot total seafood supplied and consumed (g/capita/week) between 2009 and 2018 
ggplot(df_UK_supplies_intake_avg, aes(Species, Value, fill= Commodity)) +
  geom_bar(position = "dodge", stat= "identity", color = "black") +
  scale_y_continuous(name = "National seafood supplied (g/capita/week)", limits = c(0,300)) +
  geom_hline(yintercept = 280, linetype = "dashed", color = "red", linewidth = 1.5) + 
  scale_fill_manual(values = c("#E69F00", "#009E73")) +
  theme(legend.title = element_blank()) 
...
# g/country/year
#ggplot(df_UK_SOI_capita_2018, aes(Species, Supplies)) +
#  geom_bar(stat= "identity", color = "black", fill = "#0072B2") +
#  scale_x_discrete(guide = guide_axis(angle = 90), name = "") + 
#  scale_y_continuous(name = "Seafood supplies (g)") +
#  geom_point(aes(Species, Consumption), colour= "#D55E00", size= 4) +
#  geom_point(aes(Species, Purchases), colour= "#F0E442", size= 4)
