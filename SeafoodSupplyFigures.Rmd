...
theme_set(theme_bw()%+replace%
            theme(
              ...
              panel.grid.major = element_line(colour= "gray40", linetype = "dotted", size = 0.7), 
              panel.grig.minor = element_line(colour = "gray70", linetype = "dotted", size = 0.7)
            ))
...
# Colour will be allocated in commodity alphabetical order. 
```
...
# See pivot()/ spread() command in tidyverse to efficiently merge data frames side-by-side. See dplyr cheatsheet.
```
