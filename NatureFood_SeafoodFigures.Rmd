...
# Subset for 2018 inly (most recent)
...
df_nutrientSupply <- df_UK_seafoodDBNC_2018 %>% select(Species, Year, SACN,
                                                  SupplyPUFA_gPCW,SupplyVitaminA_ugPCW, 
...
df_nutrientExports <- df_UK_seafoodDBNC_2018 %>% select(Species, Year, SACN,
                                                   ExportsPUFA_gPCW,ExportsVitaminA_ugPCW,
...
# Bar chart of nutrient supplies
str(df_nutrientExports)
