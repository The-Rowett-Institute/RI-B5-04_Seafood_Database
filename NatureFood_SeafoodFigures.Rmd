...
# Multiply nutrient content by supplies and exports

# Calcium 
X$supplies_Ca <- x$Supplies * (x$Supplies/ 100)
x$export_Ca <- x$Exports * (x$Supplies/ 100)

# Iron 


# Subset nutrient supplies and exports 
