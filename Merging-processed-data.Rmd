...
df_captureProd_NS_clean_data <- vroom(file = paste(filepath,"AllLandingsintoUK_MMO_clean.csv", sep = "/"))

# Load UK capture production data (UK landings into the UK and abroad)
df_captureProd_NS_clean_data <- vroom(file = paste(filepath,"LandingsUKAndAbroad_MMO_clean.csv", sep = "/"))
