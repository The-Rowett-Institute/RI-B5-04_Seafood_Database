...
df_captureProd_NS_clean_data <- vroom(file = paste(filepath,"CaptureProductionData_NS_clean-editAgain.csv", sep="/"))

# Load UK aquaculture data 
df_aquaProd_Eurostat_clean_data <- vroom(file=paste(filepath,"AquacultureData_Eurostat_clean-editAgain.csv", sep="/"))
...
df_housePurch_DEFRA_clean_data <- vroom(file=paste(filepath,"HouseholdPurchases_DEFRA_edit.csv", sep="/"))
...
df_consumption_NDNS_clean_data <- vroom(file=paste(filepath,"EatenOutPurchases_DEFRA.csv", sep="/"))
