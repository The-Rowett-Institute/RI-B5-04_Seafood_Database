...
# Rename the "CDID" column to "value"
names(df_UK_pop_200918)[names(df_UK_pop_200918)=="CDID"] <- "Value"
...
filepath <- paste(data_dir,"ProcessedData", sep = "")
write.csv(df_UK_pop_200918, file = paste(filepath,"UKPopulation_ONS_PreliminaryCleaned.csv", sep = ""))
