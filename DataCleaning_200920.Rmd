...
# Join data frame with MCS data frame by species name
df_UKV_LandingUKonly_200920_long <- df_UKV_LandingUKonly_200920_long %>% inner_join(., MMO_MCS_translations, by = c('SpeciesRevised' = 'Species'))
...
# Select desired columns for cleaned data set-- 16  variables
df_UKV_LandingUKonly_200920_cleaned <- df_UKV_LandingUKonly_200920_long[c("DataSupplier", "DataSet", "Commodity", "CommonSpeciesName", "SpeciesType", "SACN", "Volume", "Units", "Year", "TemporalResolution", "Flag", "FlagDescription")]

# Rename "SeafoodSpecies" column 
#df_UKV_LandingUKAbroad_200918_cleaned <- rename(df_UKV_LandingUKAbroad_200918_clean, c("SeafoodSpecies" = "Species"))

df_UKV_LandingUKonly_200920_cleaned <- df_UKV_LandingUKonly_200920_clean %>% rename(Species = CommonSpeciesName)
...
df_UKFarmed_200920 <- df_UKFarmed_200920 %>% inner_join(., CEFAS_MCS_translations, by = c('SpeciesRevised' = 'Species'))
