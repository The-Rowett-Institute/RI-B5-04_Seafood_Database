...
# Subset fish products from NDNS data
...
unique(df_NDNS_sub_Yr12$SpeciesRevised)

# Join data frame with MCS data frame by species name
df_NDNS_sub_Yr12 <- df_NDNS_sub_Yr12 %>% inner_join(., MCS_translations, by = c('SpeciesRevised' = 'Species'))
