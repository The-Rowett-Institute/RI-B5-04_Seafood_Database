...
MCS_translations <- vroom(file=paste(filepath,"SeafoodSpeciesCommonNames_12JAN2024.csv", sep="/"))
...
df_NDNS_seafood_consumption_Yr1_11 <- df_NDNS_seafood_consumption_Yr1_11 %>% 
  inner_join(., MCS_translations, by = c('SpeciesRevised' = 'Species'))
...
# Join data frame with MCS data frame by species name
df_NDNS_sub_Yr12 <- df_NDNS_sub_Yr12 %>% inner_join(., MCS_translations, by = c('SpeciesRevised' = 'Species')) # "Species" column is the unique spelling of the species in all data sets.
