...
df_NDNS_foodlevel_yr9_data = subset(df_NDNS_foodlevel_yr9data, 
...
df_NDNS_foodlevel_yr12_data$totfishperprod <- df_NDNS_foodlevel_yr12_data$WhiteFishg +
  df_NDNS_foodlevel_yr12_data$OilyFishg + df_NDNS_foodlevel_yr12_data$CannedTunag + 
  df_NDNS_foodlevel_yr12_data$Shellfishg
...
df_NDNS_foodlevel_yr12_data$SpeciesRevised <- df_NDNS_foodlevel_yr12_data$FoodName
str(df_NDNS_foodlevel_yr12_data)

str(MCS_translations)

# Join data frame with MCS data frame by species name
df_NDNS_foodlevel_yr12_data <- df_NDNS_foodlevel_yr12_data %>% inner_join(., MCS_translations, by = c('SpeciesRevised' = 'Species'))
